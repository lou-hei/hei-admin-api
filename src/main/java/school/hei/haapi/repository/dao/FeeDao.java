...
public class FeeDao {
  ...
  public List<Fee> getByCriteria(
    ...
    List<Predicate> predicates =
        getPredicate(root, query, mpbsStatus, feeType, status, studentRef, monthFrom, monthTo, isMpbs, builder);
  ...
  private List<Predicate> getPredicate(
    ...
    if (isCriteriaEmpty(status, studentRef, monthFrom, monthTo, isMpbs)) {
      ...
      buildPredicates(
          builder, root, predicates, mpbsStatus, feeType, status, studentRef, monthFrom, monthTo, isMpbs, query);
    }
    return predicates;
  }
